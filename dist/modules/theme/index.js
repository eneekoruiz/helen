...
`;
    ...
    if (r1 === 'created' || r1 === 'overwritten')
        result.created.push('src/components/ThemeProvider.tsx');
    else
        result.skipped.push('src/components/ThemeProvider.tsx');
    // useTheme hook
...
`;
    ...
    if (r2 === 'created' || r2 === 'overwritten')
        result.created.push('src/hooks/useTheme.ts');
    else
        result.skipped.push('src/hooks/useTheme.ts');
...
`;
    ...
    if (r3 === 'created' || r3 === 'overwritten')
        result.created.push('src/components/ThemeToggle.tsx');
    else
        result.skipped.push('src/components/ThemeToggle.tsx');
    result.nextSteps.push('Wrap app with <ThemeProvider>');
    result.nextSteps.push('Add <ThemeToggle /> to your navbar');
    return result;
}
export const themeModule = { meta, execute };
