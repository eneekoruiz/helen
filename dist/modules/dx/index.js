...
async function execute(ctx) {
    ...
    if (r2 === 'created' || r2 === 'overwritten')
        ...
        result.skipped.push('.vscode/extensions.json');
    // .env.example
...
`;
    ...
    if (r4 === 'created' || r4 === 'overwritten')
        result.created.push('scripts/easter-egg.ts');
    else
        result.skipped.push('scripts/easter-egg.ts');
...
export const dxModule = { meta, execute };
