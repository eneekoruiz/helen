...
Inspect all media assets and make the smallest high-impact fixes that improve quality, loading, accessibility, and presentation.
...
1. Asset issues fixed.
2. Asset issues flagged.
3. Accessibility changes.
4. Performance changes.
5. Social/favicons status.
6. Remaining asset risks.
