...
Cada flujo es una receta ejecutable por un agente.

Regla: antes de ejecutar un flujo, lee [../MASTER.md](../MASTER.md), el flujo completo, todos los prompts atómicos referenciados y los checkpoints relevantes.

## Flujos

- [full-polish.md](full-polish.md)
- [prefinal-hardening.md](prefinal-hardening.md)
- [release-candidate.md](release-candidate.md)
- [client-delivery.md](client-delivery.md)
- [market-analysis.md](market-analysis.md)
- [ux-visual-pass.md](ux-visual-pass.md)
- [clean-code-pass.md](clean-code-pass.md)
...
- [prompt-library-maintenance.md](prompt-library-maintenance.md)
