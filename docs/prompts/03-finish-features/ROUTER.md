...
## Decision rapida
- No existe infraestructura 3D: usa `generate-3d-global-canvas-setup.md`.
- Existe setup 3D y falta una escena concreta: usa `generate-3d-isolated-experience-component.md`.
- La escena existe pero parece barata o inestable: usa `enhance-3d-premium-scene-polish.md`.
