# [AUDIT] - Methodology and Blind Spots Audit
...
- Review whether prompts are grouped by real project lifecycle.
...
1. Start with the most important blind spots, ordered by severity (Críticos, Importantes, Opcionales) and leverage.
