...
- The GitHub About section is complete when public presentation matters: description, relevant URL, topics, and social preview.
...
2. List unresolved blockers, if any.
